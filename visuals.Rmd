...
elo_by_day <- all_games %>% 
  ...
  summarize(avg_daily_elo = mean(my_elo), .groups = "keep")
...
# Trying to see what distribution of games outcomes is. Maybe for further work;
...
# Openings that appear to deviate. Not included in current project.
...
# Total games played per month over time
...
# Win percentage over time. Not included as is.
...
# Performance rating by quarter, website, time control.
